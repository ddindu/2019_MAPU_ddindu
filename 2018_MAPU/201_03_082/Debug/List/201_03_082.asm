...
; 0000 000F      PORTB=0x00;
	LDI  R30,LOW(0)
	OUT  0x18,R30
; 0000 0010      PORTA=0x00;
	OUT  0x1B,R30
; 0000 0011      delay_ms(2000);
	LDI  R26,LOW(2000)
	LDI  R27,HIGH(2000)
	RCALL _delay_ms
; 0000 0012      PORTA=0xff;
	LDI  R30,LOW(255)
	OUT  0x1B,R30
; 0000 0013      TCNT2=251;
	LDI  R30,LOW(251)
...
_init:
; .FSTART _init
; 0000 0018     TCCR2=0x06;
	LDI  R30,LOW(6)
	OUT  0x25,R30
; 0000 0019     TCNT2=251;
	LDI  R30,LOW(251)
	OUT  0x24,R30
; 0000 001A     TIMSK =0x40;
	LDI  R30,LOW(64)
	OUT  0x37,R30
; 0000 001B 
; 0000 001C     PORTA=0xff; DDRA=0xff;
	LDI  R30,LOW(255)
	OUT  0x1B,R30
	OUT  0x1A,R30
; 0000 001D     PORTB=0xff; DDRB=0xff;
	OUT  0x18,R30
	OUT  0x17,R30
; 0000 001E     PORTD=0xff; DDRD=0x00;
	OUT  0x12,R30
	LDI  R30,LOW(0)
	OUT  0x11,R30
; 0000 001F 
