...
; .FSTART _main
; 0000 0013     int i;
; 0000 0014     unsigned char buff[4] = "AVR";
; 0000 0015 
...
_0x3:
; 0000 001F     {
; 0000 0020     for(i=1;i<=13;i++){
	__GETWRN 16,17,1
_0x7:
	__CPWRN 16,17,14
	BRGE _0x8
; 0000 0021         _lcd_ready();
	RCALL __lcd_ready
...
_0x8:
; 0000 0025 
; 0000 0026     for(i=1;i<=13;i++){
	__GETWRN 16,17,1
_0xA:
	__CPWRN 16,17,14
	BRGE _0xB
; 0000 0027         _lcd_ready();
	RCALL __lcd_ready
; 0000 0028         _lcd_write_data(0x18);
	LDI  R26,LOW(24)
	RCALL SUBOPT_0x0
