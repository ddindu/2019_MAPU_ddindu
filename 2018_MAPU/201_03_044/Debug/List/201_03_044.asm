...
; .FSTART _ext_int0
	RCALL SUBOPT_0x0
; 0000 000D     PORTA = 0b11110000;
	LDI  R30,LOW(240)
	RCALL SUBOPT_0x1
; 0000 000E     delay_ms(1000);
; 0000 000F     PORTA = 0b00001111;
	RJMP _0x7
...
; .FSTART _ext_int1
	RCALL SUBOPT_0x0
; 0000 0014     PORTA = 0b00111111;
	LDI  R30,LOW(63)
	RCALL SUBOPT_0x1
; 0000 0015     delay_ms(1000);
; 0000 0016     PORTA = 0b00001111;
	RCALL SUBOPT_0x2
; 0000 0017     delay_ms(1000);
; 0000 0018     PORTA = 0b00000011;
	LDI  R30,LOW(3)
	RCALL SUBOPT_0x2
; 0000 0019     delay_ms(1000);
; 0000 001A     PORTA = 0b00000000;
	LDI  R30,LOW(0)
_0x7:
	OUT  0x1B,R30
...
; 0000 0026     Init();
	RCALL _Init
; 0000 0027     EICRA |= 0x0A;
	LDS  R30,106
	ORI  R30,LOW(0xA)
	STS  106,R30
; 0000 0028     EIMSK = 0x03;
	LDI  R30,LOW(3)
	OUT  0x39,R30
; 0000 0029     #asm("sei");
	SEI
