...
; * 201_03_063.c
; *
; * Created: 2018-12-04 ¿ÀÈÄ 5:22:27
...
;	a -> R16
	...
	ORI  R30,0x40
	MOV  R16,R30
; 0000 001B     for(i=0;i<24;i++) lcd_write_byte(a++,*pc++);
	LDI  R17,LOW(0)
_0x4:
	CPI  R17,24
	BRSH _0x5
...
; 0000 0026     lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0027     lcd_putchar(0);
	LDI  R26,LOW(0)
	RCALL _lcd_putchar
; 0000 0028     lcd_gotoxy(1,0);
	LDI  R30,LOW(1)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0029     lcd_putchar(1);
	LDI  R26,LOW(1)
	RCALL _lcd_putchar
; 0000 002A     lcd_gotoxy(2,0);
	LDI  R30,LOW(2)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 002B     lcd_putchar(2);
	LDI  R26,LOW(2)
	RCALL _lcd_putchar
; 0000 002C 
; 0000 002D while (1)
