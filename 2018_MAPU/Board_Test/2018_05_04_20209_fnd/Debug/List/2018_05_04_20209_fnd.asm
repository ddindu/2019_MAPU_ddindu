...
_0x4:
; 0000 001B     {
; 0000 001C         for(i=0;i<=9999;i++){
	__GETWRN 16,17,0
_0x8:
	__CPWRN 16,17,10000
	BRGE _0x9
; 0000 001D             PORTA=fnd[i%1000/100];
	MOVW R26,R16
	LDI  R30,LOW(1000)
	LDI  R31,HIGH(1000)
	RCALL __MODW21
	...
	LDI  R31,HIGH(100)
	RCALL SUBOPT_0x0
; 0000 001E             Q0=1,Q1=1,Q2=0,Q3=1;
	SBI  0x18,1
	CBI  0x18,2
	RCALL SUBOPT_0x1
; 0000 001F             delay_ms(50);
; 0000 0020 
; 0000 0021             PORTA=fnd[i%100/10];
	LDI  R30,LOW(100)
	LDI  R31,HIGH(100)
	RCALL __MODW21
	MOVW R26,R30
	...
	LDI  R31,HIGH(10)
	RCALL SUBOPT_0x0
; 0000 0022             Q0=1,Q1=0,Q2=1,Q3=1;
	CBI  0x18,1
	SBI  0x18,2
	RCALL SUBOPT_0x1
; 0000 0023             delay_ms(50);
; 0000 0024 
; 0000 0025             PORTA=fnd[i%10/1];
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	RCALL __MODW21
	LDI  R26,LOW(_fnd)
