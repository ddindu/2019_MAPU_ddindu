...
; 0000 001B     delay_ms(500);
	...
	LDI  R27,HIGH(500)
	RCALL _delay_ms
; 0000 001C     lcd_putchar(buff);
	MOV  R26,R19
	RCALL _lcd_putchar
; 0000 001D while (1)
_0x3:
; 0000 001E     {
; 0000 001F     for(i=1;i<=15;i++){
	__GETWRN 16,17,1
_0x7:
	__CPWRN 16,17,16
	BRGE _0x8
; 0000 0020         _lcd_ready();
	RCALL __lcd_ready
; 0000 0021         _lcd_write_data(0x1c);
	LDI  R26,LOW(28)
	RCALL SUBOPT_0x0
...
; 0000 0023     }
	...
	RJMP _0x7
_0x8:
; 0000 0024     for(i=1;i<=15;i++){
	__GETWRN 16,17,1
_0xA:
	__CPWRN 16,17,16
	BRGE _0xB
; 0000 0025         _lcd_ready();
	RCALL __lcd_ready
; 0000 0026         _lcd_write_data(0x18);
	LDI  R26,LOW(24)
	RCALL SUBOPT_0x0
