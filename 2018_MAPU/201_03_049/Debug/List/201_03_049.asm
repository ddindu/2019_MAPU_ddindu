...
; 0000 0013     DDRA = 0xff;
	LDI  R30,LOW(255)
	OUT  0x1A,R30
; 0000 0014     DDRB = 0b11110000;
	LDI  R30,LOW(240)
	OUT  0x17,R30
; 0000 0015 
; 0000 0016     EICRB = 0b10101010;
	LDI  R30,LOW(170)
	OUT  0x3A,R30
; 0000 0017     EIMSK = 0b11110000;
	LDI  R30,LOW(240)
	OUT  0x39,R30
; 0000 0018     SREG |= 0x80;
	BSET 7
; 0000 0019 while (1) seg4_out();
_0x4:
	RCALL _seg4_out
	RJMP _0x4
; 0000 001A }
...
; .FEND
;void seg4_out(void){
; 0000 001B void seg4_out(void){
_seg4_out:
; .FSTART _seg4_out
; 0000 001C     PORTB = 0b11100000;
	LDI  R30,LOW(224)
	OUT  0x18,R30
; 0000 001D     PORTA = seg_pat[n1];
	MOV  R30,R5
	RCALL SUBOPT_0x0
; 0000 001E     delay_ms(100);
; 0000 001F 
; 0000 0020     PORTB = 0b11010000;
	LDI  R30,LOW(208)
	OUT  0x18,R30
; 0000 0021     PORTA = seg_pat[n10];
	MOV  R30,R4
	RCALL SUBOPT_0x0
; 0000 0022     delay_ms(100);
; 0000 0023 
; 0000 0024     PORTB = 0b10110000;
	LDI  R30,LOW(176)
	OUT  0x18,R30
; 0000 0025     PORTA = seg_pat[n100];
	MOV  R30,R7
	RCALL SUBOPT_0x0
; 0000 0026     delay_ms(100);
; 0000 0027 
; 0000 0028     PORTB = 0b01110000;
	LDI  R30,LOW(112)
	OUT  0x18,R30
; 0000 0029     PORTA = seg_pat[n1000];
	MOV  R30,R6
	RCALL SUBOPT_0x0
