...
_0x0:
	...
	.DB  0x54,0x41,0x20,0x3D,0x20,0x25,0x34,0x64
	.DB  0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 001A     lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 001B     lcd_putsf("Current Value");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 001C 
; 0000 001D     for(i=0;i<=1000;i++){
	CLR  R4
	CLR  R5
_0x7:
	LDI  R30,LOW(1000)
	...
	CPC  R31,R5
	BRLT _0x8
; 0000 001E         sprintf(sbuff,"DATA = %4d",i);
	LDI  R30,LOW(_sbuff)
	LDI  R31,HIGH(_sbuff)
	ST   -Y,R31
	ST   -Y,R30
